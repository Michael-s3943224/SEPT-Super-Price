...
export default function LoginPage()
{
    ...
    return (
        <main>
            <h1 className="text-center text-5xl font-bold text-pink-600 mb-16">Register</h1>
                ...
                <form className="w-full" onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-12 gap-3 mb-8">
                        <div className="flex items-center justify-center col-start-5 col-span-6 md:col-span-4 md:col-start-5">
                            {!isPending && <button className="btn btn-primary w-full md:w-1/3">Register</button>}
                            {isPending &&
                    ...
                    <div className="inline-flex items-center justify-center w-full">
                        ...
                        <span className="absolute px-3 text-gray-500 -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-900">Already have an account?</span>
                    </div>
                    <a href="/login" className="block text-center underline text-blue-600 hover:text-blue-800 visited:text-purple-600 hover:cursor-pointer">Login</a>
                </form>
            </div>
        </main>
    )
